...
create_generated_clock -name {CLK_FREQ_DIV} -source {inst_pll|altpll_component|pll|clk[0]} -divide_by 2 -multiply_by 1 -duty_cycle 50.00 -phase 0.0 -offset 0.0 { ddfs:inst_ddfs_mod|freq_divider_DDFS:f_div_inst|clk_out }
