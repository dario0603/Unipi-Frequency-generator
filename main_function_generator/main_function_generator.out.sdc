...
set_output_delay -min 1 [get_ports {GPIO_1[0] GPIO_1[1] GPIO_1[2] GPIO_1[3]}] -clock [get_clocks inst_pll|altpll_component|pll|clk[0]]
set_output_delay -max 1 [get_ports {GPIO_1[0] GPIO_1[1] GPIO_1[2] GPIO_1[3]}] -clock [get_clocks inst_pll|altpll_component|pll|clk[0]]
set_output_delay -min 1 [get_ports LCD*] -clock [get_clocks inst_pll|altpll_component|pll|clk[0]]
set_output_delay -max 1 [get_ports LCD*] -clock [get_clocks inst_pll|altpll_component|pll|clk[0]]
